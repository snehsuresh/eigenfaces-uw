'''
Preserves spatial information of the images.
Uses a 3D matrix to store images in their original dimensions.
might be more memory-intensive due to storing each image in its original size.
'''
